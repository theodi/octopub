  ...
  describe 'create dataset with an existing schema' do
    context 'returns an error if the file does not match the schema' do
      ...
      it 'without websockets' do
        post :create, params: { dataset_file_schema_id: @dataset_file_schema.id, dataset: @dataset, files: @files }
      ...
      it 'with websockets' do
        ...
        post :create, params: { dataset: @dataset, files: @files, channel_id: 'foo-bar',  dataset_file_schema_id: @dataset_file_schema.id }
      end
    end
